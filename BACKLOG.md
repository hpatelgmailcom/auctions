...
- [x] **Hispanic/Latino demographics** — Areavibes reports this figure in a different sentence structure; parser handles the common case but misses some city pages
